...
<div class="demo" markdown="0" style="margin: 2.25rem 0; text-align: center;">
  <img src="{{ '/assets/demo.gif' | relative_url }}"
       alt="kuberoutectl in action — sync four providers, list targets with their versions, filter by which AWS profiles a cluster actually admits, inspect credential health and access entries, label and collect, then route kubectl"
       loading="lazy"
