...
layout: default
description: "Discover, organize, and route Kubernetes access across providers"
---

## kuberoutectl

Discover, organize, and route Kubernetes access across providers
...
* [kuberoutectl credential](kuberoutectl_credential.md)	 - Inspect and renew credentials
...
* [kuberoutectl version](kuberoutectl_version.md)	 - Print build version information
